...
function ChallengeModal({ challenge, onClose }: ModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="sticky top-0 bg-white rounded-t-3xl border-b border-gray-blue p-6 flex items-start justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center shrink-0", challenge.bgColor)}>
              <Icon className={cn("w-6 h-6", challenge.color)} />
            </div>
            <div>
              <h2 className="text-xl font-extrabold text-navy">{challenge.shortName}</h2>
              <p className="text-sm text-navy/60">{challenge.name}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-8">
          <p className="text-navy/70 leading-relaxed">{challenge.description}</p>

          {/* Common signs */}
          <div className="space-y-3">
            <h3 className="text-sm font-bold text-navy uppercase tracking-wider">Common Signs</h3>
          ...
          {/* Hidden strengths */}
          <div className="bg-teal/5 rounded-2xl p-5 space-y-3 border border-teal/15">
            <h3 className="text-sm font-bold text-teal uppercase tracking-wider">Hidden Strengths</h3>
            <ul className="space-y-2">
          ...
          {/* What helps */}
          <div className="space-y-3">
            <h3 className="text-sm font-bold text-navy uppercase tracking-wider">What Helps</h3>
            <ul className="space-y-2">
          ...
          <div className="pt-2">
            <a
              href="#contact"
              onClick={onClose}
              className="flex items-center justify-center gap-2 w-full py-4 rounded-xl bg-gradient-to-r from-teal to-blue text-white font-semibold hover:shadow-lg transition-all duration-200"
            >
...
export default function ChallengeCards() {
  ...
  return (
    <section id="challenges" className="py-24 bg-off-white">
      <div ref={ref} className="max-w-6xl mx-auto px-6 space-y-12">
        <motion.div
